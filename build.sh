...
function main {
  echo "================" >>debug.txt
  echo "=== build.sh ===" >>debug.txt
  echo "================" >>debug.txt
  echo "all args         >> $@" >>debug.txt
  echo "" >>debug.txt
  echo "environment variables:" >>debug.txt
  echo "user home        >> $HOME" >>debug.txt
  echo "path             >> $PATH" >>debug.txt
  echo "current directory>> $PWD" >>debug.txt
  echo "bash pid         >> $$" >>debug.txt
  echo "" >>debug.txt
  echo date >>debug.txt
  echo "files in current directory:" >>debug.txt
  tree -L 2 >>debug.txt
  echo "" >>debug.txt
  echo "end: bash.sh" >>debug.txt
  echo "" >>debug.txt
